...
class FileFormat {
    ...
    renameFilesInDirectory(directory, isRecursive) {
        console.log(isRecursive ?  ' yes is recursive': 'no recursive')
        let filesChanged = 0;
        ...
        for (const file of files) {
            ...
            const isTheFormat = format === this.currentFileFormat
            ...
            if (
                ...
                this.renameFilesInDirectory(file.path + '/' + file.name, true)
            }
        }
